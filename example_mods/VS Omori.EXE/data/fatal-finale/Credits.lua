...
--IF YOU ARE NOT USING CERTAIN NAME SLOTS, JUST LEAVE THEM BLANK 
	...
	MusicianName1 = 'Penkaru'
	MusicianName2 = 'Zeroh'
	MusicianName3 = 'TheRoyalTony'
...
Start = 15 --choose which "STEP" to activate the script on
...
function onCreate()
	...
	--CODER TEXT
	makeLuaText('CODERS', 'CODER', 1280, HorizontalWordsOffset, -1000)
	setTextAlignment('CODERS', 'center')
	setTextSize('CODERS', 30)
	setObjectCamera('CODERS', 'other')
	addLuaText('CODERS')
	setTextFont('CODERS', Font)

	--ARTWORK TEXT
	makeLuaText('ARTISTS', 'ORIGINAL ASSETS', 1280, HorizontalWordsOffset, -1000)
	setTextAlignment('ARTISTS', 'center')
	setTextSize('ARTISTS', 30)
	...
	function onStepHit()
		...
		if curStep == Start then
			...
			----CHARTERS TEXT----
			doTweenY('CHARTEXT', 'CHARTERS', 140, TweenSpeed/1.6, 'QuadOut')
			doTweenY('CHARTER1', 'CHARTER1', 180, TweenSpeed/1.6, 'QuadOut')
			doTweenY('CHARTER2', 'CHARTER2', 210, TweenSpeed/1.6, 'QuadOut')
			doTweenY('CHARTER3', 'CHARTER3', 240, TweenSpeed/1.6, 'QuadOut')

			----CODERS TEXT----
			doTweenY('CODETEXT', 'CODERS', 280, TweenSpeed/1.6, 'QuadOut')
			doTweenY('CODER1', 'CODER1', 320, TweenSpeed/1.6, 'QuadOut')
			doTweenY('CODER2', 'CODER2', 350, TweenSpeed/1.6, 'QuadOut')
			doTweenY('CODER3', 'CODER3', 380, TweenSpeed/1.6, 'QuadOut')
			...
			----ARTISTS TEXT----
			doTweenY('ARTTEXT', 'ARTISTS', 560, TweenSpeed/1.6, 'QuadOut')
			doTweenY('ARTIST1', 'ARTIST1', 600, TweenSpeed/1.6, 'QuadOut')
			doTweenY('ARTIST2', 'ARTIST2', 630, TweenSpeed/1.6, 'QuadOut')
			doTweenY('ARTIST3', 'ARTIST3', 660, TweenSpeed/1.6, 'QuadOut')
