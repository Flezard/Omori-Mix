...
function onBeatHit()
    if curBeat == 1672 then
        ...
        if songExists == true then
            ...
            setTextString('creditCharter', CharterName)
            --Tweens--
...
function onCreatePost() -- This creates all the placeholder shit B) ((THIS PART OF THE SCRIPT WAS MADE BY PIGGY))
    ...
    makeGraphic('creditBox', objWidth, 50, '000000')
    ...
    makeLuaText('creditCharter', 'PlaceholderCharter', objWidth, offsetX - objWidth, offsetY)--//80)
    setTextSize('creditCharter', 38)
...
if songExists == true then
    ...
    --setTextString('creditComposer', "Song: "..curSongTable[2])
    --setTextString('creditArtist', "Art: "..curSongTable[4])
    setTextString('creditCharter', CharterName)--..curSongTable[5])
